...
namespace GeolocatorTests
{
	...
	public partial class HomePage : TabbedPage
	{
		...
		private async void ButtonPositionForAddress_Clicked(object sender, EventArgs e)
		{
			try
			{
				...
				var address = await locator.GetPositionsForAddressAsync(EntryAddress.Text, "RJHqIE53Onrqons5CNOx~FrDr3XhjDTyEXEjng-CRoA~Aj69MhNManYUKxo6QcwZ0wmXBtyva0zwuHB04rFYAPf7qqGJ5cHb03RCDw1jIW8l");
				if (address == null || address.Count() == 0)
				{
					LabelAddress.Text = "Unable to find position";
				}

				var a = address.FirstOrDefault();
				LabelPositionForAddress.Text = $"Latitude = {a.Latitude}\nLongitude = {a.Longitude}";
			...
			{
				ButtonPositionForAddress.IsEnabled = true;
			}
		}
